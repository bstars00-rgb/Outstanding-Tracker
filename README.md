...
[ELLIS_MCP_RECEIVABLES_SPEC_FOR_DEV (개발팀 전달용 연동 스펙)](docs/ELLIS_MCP_RECEIVABLES_SPEC_FOR_DEV.md) · [ELLIS_PLAYBOOK_DATA_MODEL (플레이북 필드 카탈로그)](docs/ELLIS_PLAYBOOK_DATA_MODEL.md)
